...
router.post('/user', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, index_1.client.query("INSERT INTO users (name, email) VALUES ('" + xss_1["default"](name) + "', '" + xss_1["default"](email) + "');")];
            case 2:
                _b.sent();
                res.send({
                    data: {
                        name: xss_1["default"](name),
                        email: xss_1["default"](email)
                    },
                    message: 'OK'
                });
                return [3 /*break*/, 4];
            case 3:
                err_1 = _b.sent();
                console.error(err_1.detail);
                res.send({ message: err_1.detail });
                return [3 /*break*/, 4];
